...
void DcmAlgorithm::getQ(float *quant1, float *quant2, float *quant3, float *quant4){
  ...
  float cy = cos(_yaw * 0.5);
  float sy = sin(_yaw * 0.5);
  float cr = cos(_roll * 0.5);
  float sr = sin(_roll * 0.5);
  float cp = cos(_pitch * 0.5);
  float sp = sin(_pitch * 0.5);
