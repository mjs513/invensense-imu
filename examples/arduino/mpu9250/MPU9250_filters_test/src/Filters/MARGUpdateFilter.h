///////////////////////////////////////////////////////////////////////////////////////
// 
// Implementation of Madgwick's Original AHRS Algorithms
///////////////////////////////////////////////////////////////////////////////////////
...
// -----------------------------------------------------------
  ...
  #define zeta0 sqrt(3.0f / 4.0f) * gyroMeasDrift       // compute zeta
...
void MARGUpdateFilter(float w_x, float w_y, float w_z, float a_x, float a_y, float a_z, 
					  float m_x, float m_y, float m_z, float deltat)
{
    ...
    // auxilary variables to avoid reapeated calculations
    ...
    w_bx += w_err_x * deltat * zeta0;
    w_by += w_err_y * deltat * zeta0;
    w_bz += w_err_z * deltat * zeta0;
    w_x -= w_bx;
    w_y -= w_by;
    w_z -= w_bz;
    ...
    SEq_1SEq_2 = SEq_1 * SEq_2; // recompute a_xulirary variables
...
void MARGUpdateFilterIMU(float w_x, float w_y, float w_z, 
						 float a_x, float a_y, float a_z, float deltat)
{
	// Local system variables
	float norm; // vector norm
	...
	// a_xulirary variables to avoid reapeated calcualtions
