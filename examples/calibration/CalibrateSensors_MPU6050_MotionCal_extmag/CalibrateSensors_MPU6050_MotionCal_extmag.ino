...
void loop() {
  ...
  // get and print scaled data (uncalibrated)
  //For  my board layout going to use NWU coordinates.
  if(imu.Read(raw_values)){
    if(imu.new_imu_data()){
      ...
      Serial.print(int (-mag_val[0]*10));
      Serial.print(',');
      Serial.print(int (mag_val[1]*10));
      Serial.print(',');
      Serial.print(int (-mag_val[2]*10));
      Serial.println("");
      #endif
